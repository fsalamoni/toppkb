...
const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      { to: '/app/treinamento/composicao', label: 'Composição Corporal', icon: Ruler, badge: null as string | null },
      { to: '/app/treinamento/recuperacao', label: 'Recuperação', icon: Heart, badge: null as string | null },
      { to: '/app/treinamento/config', label: 'Configurações', icon: Settings, badge: null as string | null },
